...
const Slider = exports.Slider = /*#__PURE__*/(0, _react.memo)(function Slider({
  ...
  const nearestMarkX = (0, _reactNativeReanimated.useDerivedValue)(() => {
    'worklet';
  ...
  const thresholdDistance = (0, _reactNativeReanimated.useDerivedValue)(() => {
    'worklet';
  ...
  const onGestureEvent = (0, _react.useMemo)(() => {
    ...
    return gesture;
  }, [activeOffsetX, activeOffsetY, bubbleOpacity, disable, disableTrackFollow, failOffsetX, failOffsetY, isScrubbing, isScrubbingInner, nearestMarkX, onActiveSlider, onSlidingComplete, onSlidingStart, panDirectionValue, panHitSlop, prevX, progress, shareValueToSeconds, snapThreshold, step, thresholdDistance, xToProgress]);
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.GestureDetector, {
    ...
    const left = Math.round(sliderWidth * (i / step) - i / step * markWidth);
